...
<div id="layoutSidenav_content" class="container">
	<div class="card"> 
		<div class="card-header">
			<h3 class="display-2" style="font-size: 2rem;"> Proje Görüntüleme Sayfası </h3>
		</div>
		<div class="card-body">
			<form action="islemler/islem.php" method="POST">
				...
				<input type="hidden" name="proje_id" value="<?php echo $_POST['proje_id'] ?>"> <br>
				<button type="submit" class="btn btn-danger mt-2" name="projebak"> Geri Dön </button>
			</form> 
