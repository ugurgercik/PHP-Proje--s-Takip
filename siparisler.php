...
<h1 class="font-weight-bold"> Siparişleriniz </h1>
  <p class="mb-4">Buradaki alandan siparişlere ait bilgileri görüntüleyebilir ve dışa aktarabilirsiniz.</p>
...
<script>
  ...
  $('#acil').on('click', function () {
    ...
    .search( 'YES' )
    .draw();
    dataTables.column(6).search("Acil").draw();
  }); 
  $('#normal').on('click', function () {
    ...
    .search( 'YES' )
    .draw();
    dataTables.column(6).search("Normal").draw();
  }); 
  $('#acelesiyok').on('click', function () {
    ...
    .search( 'YES' )
    .draw();
    dataTables.column(6).search("Acelesi Yok").draw();
  }); 
  $('#bitti').on('click', function () {
    ...
    .search( 'YES' )
    .draw();
    dataTables.column(7).search("Bitti").draw();
  }); 
  $('#devam').on('click', function () {
    ...
    .search( 'YES' )
    .draw();
    dataTables.column(7).search("Devam Ediyor").draw();
  }); 
  $('#yeni').on('click', function () {
    ...
    .search( 'YES' )
    .draw();
    dataTables.column(7).search("Yeni Başladı").draw();
  });
</script>
