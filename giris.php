      ...
      <div class="card o-hidden border-0 shadow-md" style="min-width: 45%">
       <div class="p-5">
        <div class="text-center">
          <h2 class="h2 text-gray-900 mb-4">Hoş Geldiniz  </h2>
        </div>
        <form class="user" action="islemler/islem.php" method="POST">
          ...
          <div class="form-group">
            <input name="kul_sifre" type="password" required  class="form-control form-control-user" id="exampleInputPassword" placeholder="Şifre">
          </div>
